...
4. `notebooks` Notebooks for manage dataset upload and perform tests
...
2. Push changes and create a pull request, it will trigger workflow to run the training pipeline
